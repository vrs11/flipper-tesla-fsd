...
<div class="card">
  ...
  <div class="row">
    <span class="action-dot"><span class="blinkdot" id="slu"></span>Stalk Light Up</span>
    <span class="action-dot"><span class="blinkdot" id="sld"></span>Stalk Light Down</span>
  </div>
  <div class="row">
  ...
  <div class="log-info" id="testInfo">AP enable sends the observed 0x340 double full-down test sequence when Active and AP Ready.</div>
</div>
...
static String build_json() {
    ...
    auto recent = [now_ms](uint32_t ts) -> bool {
        return ts != 0u && (uint32_t)(now_ms - ts) <= 350u;
    };
